...
import jhkim105.tutorials.spring.controller.dto.AccountResponse
...
class AccountControllerIntegrationTest {
    ...
    fun setup() {
        ...
        accountRepository.save(Account("1", BigDecimal(1000)))
        accountRepository.save(Account("2", BigDecimal(500)))
    }
    ...
    fun `should create a new account successfully`() {
        ...
        val savedAccount = accountRepository.findById(createdAccount.id)
    ...
    fun `should transfer amount between accounts successfully`() {
        ...
        val updatedFromAccount = accountRepository.findById(fromAccountId).get()
        val updatedToAccount = accountRepository.findById(toAccountId).get()
